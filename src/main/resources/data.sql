...
insert into FormativeAction(ID_fa, nameFa, totalPlaces, objectives, mainContent, status, enrollmentStart, enrollmentEnd) values
	(1000, 'Initiation to scrum',	 6,	'some objctives', 'some main content', 'EXECUTED', '2021-01-01 00:00:00',	'2021-02-01 00:00:00'),
	(1001, 'Initiation to agile',	10, 	'some objctives', 'some main content', 'EXECUTED', '2021-01-01 00:00:00',	'2021-02-08 00:00:00'),
	(1002, 'JDBC',  		 4,  	'some objctives', 'some main content', 'ACTIVE',   '2021-03-01 00:00:00',	'2021-04-08 00:00:00'),
	(1003, 'Java programming',	 5,	'some objctives', 'some main content', 'ACTIVE',   '2021-04-01 00:00:00',	'2021-04-28 00:00:00');

insert into Session(ID_session, ID_fa, location, duration, sessionStart) values
	(0, 1000, 'online', 2, '2021-02-03 15:00:00'),
	(1, 1000, 'online', 2, '2021-02-04 15:00:00'),
	(2, 1000, 'online', 2, '2021-02-05 15:00:00'),
	(3, 1001, 'online', 3, '2021-02-10 09:00:00'),
	(4, 1001, 'online', 3, '2021-02-11 09:00:00'),
	(5, 1002, 'online', 3, '2021-04-10 12:00:00'),
	(6, 1003, 'online', 4, '2021-05-01 10:00:00');
...
insert into Enrollment(ID_fa, ID_professional, status, timeEn, category) values
	(1000, 2000, 'RECEIVED', '2021-01-02 16:00:00', 'Standard'),
	(1000, 2001, 'CONFIRMED', '2021-01-04 17:00:00', 'Standard'),
	(1000, 2002, 'CONFIRMED', '2021-01-07 18:00:00', 'Standard'),
	(1000, 2003, 'CONFIRMED', '2021-01-10 19:00:00', 'Standard'),
	(1000, 2004, 'CONFIRMED', '2021-01-13 10:00:00', 'Standard'),
	(1000, 2005, 'CONFIRMED', '2021-01-16 13:00:00', 'Standard'),
	(1001, 2000, 'CONFIRMED', '2021-01-02 12:00:00', 'Standard'),
	(1001, 2001, 'CONFIRMED', '2021-01-13 14:00:00', 'Standard'),
	(1001, 2002, 'CONFIRMED', '2021-01-23 22:00:00', 'Standard'),
	(1001, 2003, 'CONFIRMED', '2021-02-03 20:00:00', 'Standard'),
	(1001, 2004, 'CONFIRMED', '2021-02-01 08:00:00', 'Standard'),
	(1002, 2000, 'CONFIRMED', '2021-03-02 12:00:00', 'Standard'),
	(1002, 2005, 'RECEIVED', '2021-03-05 08:00:00', 'Standard'),
	(1002, 2001, 'CONFIRMED', '2021-03-05 08:00:00', 'Standard');
...
insert into Payment(ID_payment, amount, datePay, confirmed, ID_invoice) values
	(3000, 15, '2021-01-02 17:00:00', true, 4000),
	(3001, 15, '2021-01-04 18:00:00', true, 4001),
	(3002, 15, '2021-01-07 20:00:00', true, 4002),
	(3003, 15, '2021-01-11 12:00:00', true, 4003),
	(3004, 15, '2021-01-14 13:00:00', true, 4004),
	(3005, 15, '2021-01-16 14:00:00', true, 4005),
	(3006, 10, '2021-01-02 18:00:00', true, 4006),
	(3007, 10, '2021-01-13 15:00:00', true, 4007),
	(3008, 10, '2021-01-24 08:00:00', true, 4008),
	(3009, 10, '2021-02-04 10:00:00', true, 4009),
	(3010, 10, '2021-02-01 15:00:00', true, 4010),
	(3011, 30, '2021-03-22 13:00:00', false, 4011),
	(3012, 10, '2021-03-03 13:00:00', false, 4012),
	(3013, 20, '2021-03-05 10:00:00', true,  4013),
	(3014, -10, '2021-03-05 10:00:00', true, 4000);
...
insert into PaymentTeacher( ID_payment, amount, datePay,  confirmed, ID_invoice) values
	(3000, 50, '2021-01-02 00:00:00 ', true, '4000'),
	(3001, 30, '2021-01-04 00:00:00 ', false, '4001'),
	(3002, 70, '2021-01-07 00:00:00 ', false, '4002'),
	(3003, 70, '2021-05-04 00:00:00 ', true, '4005');
