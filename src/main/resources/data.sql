...
insert into formativeAction(id, name, objectives, mainContents, teacher, manager, remuneration, location, spaces, day, numberOfHours, enrollmentPeriodStart, enrollmentPeriodEnd, fee) values 
	(1000, 'initiation to scrum', 'bla', 'blub', 1000, 1000,  100, 'EPI', 15, '2016-10-05',  2, '2016-09-01', '2016-10-01', 10),
	(1001, 'initiation to agile', 'bla1', 'blub1', 1000, 1000, 80, 'online', 20, '2016-10-07',  3, '2016-09-29', '2016-10-01', 10);
