...
public class View extends JFrame {
	...
	public View() {
		...
		coiipaPanel.setBounds(862, 60, 220, 232);
		...
		dateIn.setBounds(10, 134, 201, 55);
		...
		isCash.setBounds(10, 196, 164, 23);
